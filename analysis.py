...
print('Accuracy: ', best_v_menn_row["acc"] / vow_acc)
...
print('Accuracy: ', best_s_menn_row["acc"] / sat_acc)
...
print('Accuracy: ', best_v_fcnn_row["acc"] / vow_acc)
...
print('Accuracy: ', best_s_fcnn_row["acc"] / sat_acc)
...
plt.xticks(indices, ['Storage (ratio)', 'Time (ratio)', 'Accuracy'])
plt.legend()
plt.show()
